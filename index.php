...
<html lang="en">
    <head>
        <title>Expert Appliance Repair Services|Home & Commercial|Trusted Technicians</title>
        <!-- Google Tag Manager -->
        <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
        j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
        'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        })(window,document,'script','dataLayer','GTM-MK8HDK48');</script>
        <!-- End Google Tag Manager -->
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
        <META name="description" content="Certified repair for LG, Samsung, Dacor in San Diego. Reliable appliance repair services for all home and commercial brands." />

        <meta name="author" content="Rescue My Appliances company service SoCal" />
        <meta name="keywords" content="appliance repair, home appliance service, commercial appliance repair, LG certified, Samsung certified, Dacor certified">
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="assets/img/favicon.ico"  />
       <!-- Flaticon icons -->
       <link rel="stylesheet"  type="text/css" href="css/icons/font/flaticon.css">
        <!-- Google fonts-->
        <link href="https://fonts.googleapis.com/css?family=Merriweather+Sans:400,700" rel="stylesheet"  as="font" />
        <link href="https://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic" rel="stylesheet" as="font" />
    ...
    <body id="page-top">
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MK8HDK48"
            ...
            <div class="container h-100">
                ...
                <div class="col-md-6 col-lg-7 mb-4">
                    ...
                    <div class="col-lg-10 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">The diagnostic is <span style="text-decoration: line-through;">$95</span> FREE with the service
                           
                        </p>
                        <a class="btn btn-primary" href="tel:8588793344" >Call now 858-879-3344</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-5">
                    <form id="myform" method="POST" class="myform" action=""> 
                        ...
                        <input class="btn btn-primary form-control" style="cursor: pointer;" name="submit" type="submit" value="Submit" />
                    </form>
                </div>
                </div>
            </div>
        ...
        <section class="page-section" id="about">
            <div class="container">
                ...
                <div class="col-md-6">
                    <img src="assets/img/appliance_repair_company_technician.jpg" loading="lazy" width="640" height="360" class="img-fluid" alt="The technician of Rescue My Appliances. Appliance repair company">
                </div>
            </div>
            </div>
        </section>
            ...
            <div class="container-fluid p-0">
                <div class="row no-gutters">
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/appliances_repair_dishwasher.jpg">
                            <img class="img-fluid" loading="lazy" width="640" height="426" src="assets/img/portfolio/thumbnails/appliances_repair_dishwasher.jpg" alt="Appliance repair technician fixing the dishwasher" />
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/appliances_repair_washer.jpg">
                            <img class="img-fluid" loading="lazy" width="640" height="426" src="assets/img/portfolio/thumbnails/appliances_repair_washer.jpg" alt="Appliance repair technician fixing the washer" />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/appliances_repair_microwave.jpg">
                            <img class="img-fluid" loading="lazy" width="640" height="426" src="assets/img/portfolio/thumbnails/appliances_repair_microwave.jpg" alt="Appliance repair technician fixing the microwave" />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/appliances_repair_refrigerator_compressor.jpg">
                            <img class="img-fluid" loading="lazy" width="640" height="426" src="assets/img/portfolio/thumbnails/appliances_repair_refrigerator_compressor.jpg" alt="Appliance repair technician fixing the door latch on the washer" />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/appliances_repair_oven.jpg">
                            <img class="img-fluid" loading="lazy" width="640" height="426" src="assets/img/portfolio/thumbnails/appliances_repair_oven.jpg" alt="Appliance repair technician fixing the oven" />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/appliances_repair_door_latch_washer.jpg">
                            <img class="img-fluid" loading="lazy" width="640" height="426" src="assets/img/portfolio/thumbnails/appliances_repair_door_latch_washer.jpg" alt="Appliance repair technician fixing the refrigerator compressor" />
        ...
        <section class="page-section" id="testimonial">
            <div class="container text-center">
                ...
                <hr class="divider my-4" />
                <!-- <div class="row"> -->
                <?php include 'views/testimonial.php'; ?>
                <!-- </div> -->
            </div>
        </section>
        <!-- Call to action -->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-left">
                        ...
                        <!-- <p class="text-muted text-left"><i class="flaticon-bear"></i>
                        B.E.A.R. License <a href="https://search.dca.ca.gov/details/3900/A/48591/13a6d558f97c94dc473c9466c9283c8b" target="_blank" class="text-muted text-left" style="text-decoration:none">48591</a>
                        </p> -->
                        <a class=" callNow btn btn-primary d-lg-none" href="tel:8588793344" aria-label="Call us at 858-879-3344"><i class="flaticon-phone"></i> 858-879-3344 </a>
        ...
        <footer class="bg-light py-5">
            <div class="container">
                <div class="small text-center text-muted">Copyright 
                    ...
                    <?php echo date("Y"); ?> - Rescue My Appliances
                    |<span>B.E.A.R. License <a href="https://search.dca.ca.gov/details/3900/A/48591/13a6d558f97c94dc473c9466c9283c8b" target="_blank" class="text-muted text-left" style="text-decoration:none">48591</a></span>
                </div>
            </div>

        </footer>
        <a class=" callNow btn btn-primary d-lg-none" href="tel:8588793344"> 
           <i class="flaticon-phone"></i> 858-879-3344
        </a> 
